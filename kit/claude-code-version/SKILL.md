...
2. Email sweep, last 7 days: one search per known sender, then keywords: school OR camp OR teacher OR enrollment OR "spirit week" OR "picture day" OR "early release" OR appointment OR RSVP OR "sign up" OR permission, PLUS every keyword on the WATCHLIST in family.md. Not connected: ask for a paste of anything from school, camps, doctors, the partner, or any watchlist sender.
